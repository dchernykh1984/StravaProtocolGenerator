...
def _render_stage_outputs(
    ...
    columns = StageColumns(
        ...
        disable_dnf=stage.disable_dnf,
        group_label=stage.group_label,
        show_year=stage.show_year,
        year_label=stage.year_label,
        show_team=stage.show_team,
        team_label=stage.team_label,
        show_city=stage.show_city,
        city_label=stage.city_label,
...
def _render_cup_outputs(
    ...
    columns = CupColumns(
        ...
        disable_dnf=cup.disable_dnf,
        group_label=cup.group_label,
        show_year=cup.show_year,
        year_label=cup.year_label,
        show_team=cup.show_team,
        team_label=cup.team_label,
        show_city=cup.show_city,
        city_label=cup.city_label,
